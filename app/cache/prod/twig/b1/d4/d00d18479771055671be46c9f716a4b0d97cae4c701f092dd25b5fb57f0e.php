...
<div id=\"body_style\" style=\"width:100%;height:100%;padding:0;margin:0;\">
    ...
    <table width=\"600\" class=\"table\" style=\"margin:auto; background:#FFFFFF; border:1px solid #bebebe; -moz-border-radius:5px; border-radius:5px;\">
        ...
        // line 95
        if (((isset($context["availability"]) ? $context["availability"] : null) == "immediately")) {
            echo "Immediately";
        } else {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, (isset($context["dateTime"]) ? $context["dateTime"] : null), "Y-m-d H:i A"), "html", null, true);
        }
        // line 96
        echo "                </p>
            </td>

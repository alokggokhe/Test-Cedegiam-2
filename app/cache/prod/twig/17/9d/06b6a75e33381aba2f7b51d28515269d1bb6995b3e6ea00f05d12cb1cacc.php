...
class __TwigTemplate_179d06b6a75e33381aba2f7b51d28515269d1bb6995b3e6ea00f05d12cb1cacc extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "
                    ";
        // line 17
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "getFlashBag", array()), "has", array(0 => "error"), "method")) {
            // line 18
            echo "                        ";
            $context["error"] = true;
            // line 19
            echo "                    <div class=\"alert alert-danger\">
                        ";
            // line 20
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "getFlashBag", array()), "get", array(0 => "error"), "method"), 0, array(), "array"), "html", null, true);
            echo "
                    </div>
                    ";
        }
        ...
        // line 28
        echo ((((isset($context["error"]) ? $context["error"] : null) && twig_length_filter($this->env, (isset($context["email"]) ? $context["email"] : null)))) ? (" error") : (""));

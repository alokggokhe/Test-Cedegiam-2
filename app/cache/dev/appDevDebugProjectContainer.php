...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.form.type.admin_login' => 'getAdmin_Form_Type_AdminLoginService',
            'admin.form.type.edit_msl' => 'getAdmin_Form_Type_EditMslService',
            'adminbundle.twig.mainbundle_extension' => 'getAdminbundle_Twig_MainbundleExtensionService',
            ...
            'hcp_mailer' => 'getHcpMailerService',
            'http_kernel' => 'getHttpKernelService',
            'kernel' => 'getKernelService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'main.form.type.invitation' => 'getMain_Form_Type_InvitationService',
            ...
            'msl_mailer' => 'getMslMailerService',
    ...
    /**
     * Gets the 'admin.form.type.admin_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AdminBundle\Form\Type\AdminLoginType A AdminBundle\Form\Type\AdminLoginType instance.
     */
    protected function getAdmin_Form_Type_AdminLoginService()
    {
        return $this->services['admin.form.type.admin_login'] = new \AdminBundle\Form\Type\AdminLoginType();
    }

    /**
     * Gets the 'admin.form.type.edit_msl' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AdminBundle\Form\Type\EditMslType A AdminBundle\Form\Type\EditMslType instance.
     */
    protected function getAdmin_Form_Type_EditMslService()
    {
        return $this->services['admin.form.type.edit_msl'] = new \AdminBundle\Form\Type\EditMslType();
    }

    /**
     * Gets the 'adminbundle.twig.mainbundle_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AdminBundle\Twig\AdminbundleExtension A AdminBundle\Twig\AdminbundleExtension instance.
     */
    protected function getAdminbundle_Twig_MainbundleExtensionService()
    {
        return $this->services['adminbundle.twig.mainbundle_extension'] = new \AdminBundle\Twig\AdminbundleExtension();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'dandelion_12_last', 'user' => 'root', 'password' => 'aloha', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/MainBundle/Entity'), 1 => ($this->targetDirs[3].'/src/AdminBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('MainBundle' => 'MainBundle\\Entity', 'AdminBundle' => 'AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_eda6bd4a44c762bc1a1b80f7d125401b0894bb35d924e29c94dcec80a645bc86');
    ...
    /**
     * Gets the 'hcp_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MainBundle\Services\Mailer\HcpMailer A MainBundle\Services\Mailer\HcpMailer instance.
     */
    protected function getHcpMailerService()
    {
        return $this->services['hcp_mailer'] = new \MainBundle\Services\Mailer\HcpMailer($this->get('doctrine.orm.default_entity_manager'), $this->get('templating'), $this->get('swiftmailer.mailer.default'), 'ds.au1@ucb.com');
    }
    ...
    /**
     * Gets the 'main.form.type.invitation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MainBundle\Form\Type\InvitationType A MainBundle\Form\Type\InvitationType instance.
     */
    protected function getMain_Form_Type_InvitationService()
    {
        return $this->services['main.form.type.invitation'] = new \MainBundle\Form\Type\InvitationType();
    }
    ...
    /**
     * Gets the 'msl_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MainBundle\Services\Mailer\MslMailer A MainBundle\Services\Mailer\MslMailer instance.
     */
    protected function getMslMailerService()
    {
        return $this->services['msl_mailer'] = new \MainBundle\Services\Mailer\MslMailer($this->get('doctrine.orm.default_entity_manager'), $this->get('templating'), $this->get('swiftmailer.mailer.default'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'MainBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminSecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'therapeutic_area_user'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '_security_logout'));
        ...
        $h->setOptions(array('login_path' => '_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $h->setProviderKey('admin_secured_area');

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $i->setOptions(array('login_path' => '_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.admin_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.admin'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'admin_secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'admin_secured_area', $h, $i, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '55393b82a4870', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'admin_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_security_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.admin'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('dandelionsf2');
        $a->setPassword('Dandelionsf2$');
        $a->setAuthMode('login');
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('admin_secured_area', '_security_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('adminbundle.twig.mainbundle_extension'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('flutzut1');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/MainBundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/AdminBundle/Resources/config/validation.yml')));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('msl'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('msl_add_edit'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('msl_list'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('msl_get'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('msl_delete'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('therapeutic_area_user'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('therapeutic_area_add_edit'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('therapeutic_area_list'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        $a = $this->get('security.user.provider.concrete.admin');
        $b = $this->get('security.encoder_factory');

        $c = new \Symfony\Component\Security\Core\User\UserChecker();

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'admin_secured_area', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55393b82a4870'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'demo_secured_area', $b, true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.admin'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'MainBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'dandelion_12_last',
            'database_user' => 'root',
            'database_password' => 'aloha',
            'mailer_transport' => 'smtp1',
            'mailer_host' => '127.0.0.11',
            'mailer_user' => 'null1',
            'mailer_password' => 'null1',
            'locale' => 'en',
            'secret' => 'flutzut1',
            'cas_protocol' => 'S11',
            'cas_server' => 'www.rowa-secure1.com',
            'cas_port' => 4431,
            'cas_path' => '/sso1/',
            'owa_login' => 'https://www.rowa-secure.com1/sso/login',
            'owa_forgot' => 'https://www.rowa-secure.com1/webservice/OWAWebService?wsdl',
            'relatedae_email' => 'ds.au1@ucb.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dandelionsf2',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Dandelionsf2$',

...
class __TwigTemplate_b1d4d00d18479771055671be46c9f716a4b0d97cae4c701f092dd25b5fb57f0e extends Twig_Template
{
...
<div id=\"body_style\" style=\"width:100%;height:100%;padding:0;margin:0;\">
    ...
    <table width=\"600\" class=\"table\" style=\"margin:auto; background:#FFFFFF; border:1px solid #bebebe; -moz-border-radius:5px; border-radius:5px;\">
        ...
        <tr  style=\" color:#0070c0; font-family:Helvetica,sans-serif; font-size:12pt; line-height:1.2; text-align: left; background-image: url('https://www.ucbdandelion.com/bundles/main/images/bg-newsletter-part2.jpg');; background-repeat:no-repeat; padding:0 0 0 0; \" alink=\"#333333\" link=\"#333333\"  text=\"#333333\" yahoo=\"fix\">
            <td colspan=\"8\">
                <h2 style=\"padding:0 0 0 20px;\">HCP request for Immediate Callback</h2></td>
        </tr>
        <!--entete -->
        <tr></tr>
        <tr>
        ...
        echo " just made a 1:1 remote presentation request on the Dandelion portail.<br />
                    At the date and time of the call, please logon to the Dandelion platform (<a href=\"http://www.ucbdandelion.com\">www.ucbdandelion.com</a>) and initiate the call.<br />
                    Phone : ";
        // line 92
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["topic"]) {
            if ($this->getAttribute($context["loop"], "last", array())) {
                echo twig_escape_filter($this->env, $this->getAttribute($context["topic"], "name", array()), "html", null, true);
                echo " ";
            } else {
                echo twig_escape_filter($this->env, $this->getAttribute($context["topic"], "name", array()), "html", null, true);
                echo ", ";
        ...
        // line 95
        if (((isset($context["availability"]) ? $context["availability"] : $this->getContext($context, "availability")) == "immediately")) {
            echo "Immediately";
        } else {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, (isset($context["dateTime"]) ? $context["dateTime"] : $this->getContext($context, "dateTime")), "Y-m-d H:i A"), "html", null, true);
        }
        // line 96
        echo "                </p>
            </td>
    ...
    {
        return "MainBundle:Mail:msl.html.twig";
    }
    ...
    {
        return array (  167 => 96,  161 => 95,  157 => 94,  119 => 93,  115 => 92,  110 => 90,  19 => 1,);
    }
}
